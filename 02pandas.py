...
print("ts periods=24, freq='3M'")
ts = pd.date_range(
    start='2023-01-01', end=None, periods=24, freq='3M', tz='Asia/Seoul'
    )
print(ts)
print()
...
ts2 = pd.date_range(
    start='2023-01-01', end=None, periods=24, freq='M', tz='Asia/Seoul'
    )
print(ts2)
print()
...
ts3 = pd.date_range(
    start='2022-01-01', end=None, periods=24, freq='MS', tz='Asia/Seoul'
    )
print(ts3)
print()
